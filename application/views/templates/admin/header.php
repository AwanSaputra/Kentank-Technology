        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item"><a href="<?php echo base_url('index.php/admin/products') ?>" class="nav-link">Products</a></li>
                    <li class="nav-item"><a href="<?php echo base_url('index.php/admin/supplier') ?>" class="nav-link">Supplier</a></li>
